...
os.system("cat 01-flags-aos/slurm-45626.out | grep seconds | awk '{print $1,$3}' >> time-aos.dat")
os.system("echo '# tiempo, incerteza' > time-soa.dat")
os.system("cat 02-flags-soa/slurm-45621.out | grep seconds | awk '{print $1,$3}' >> time-soa.dat")
os.system("echo '# tiempo, incerteza' > time-mix.dat")
os.system("cat 03-mixed-precision/slurm-45625.out | grep seconds | awk '{print $1,$3}' >> time-mix.dat")
...
plt.scatter(x_soa, mix_time, marker="^", s=30, color="tab:blue", label="mixed precision")
